#!/usr/bin/env python3
"""
PostgreSQL Database setup script for Walmart Risk Detection System
Creates database and sample data for hackathon demo
"""
...
def setup_tables_and_data():
    ...
    print("📊 Setting up tables and sample data...")
...
if __name__ == "__main__":
    ...
    print(f"🔧 Database Name: {os.getenv('DB_NAME', 'walmart_risk_db')}")
    print(f"🔧 Database User: {os.getenv('DB_USER', 'postgres')}")
    print()
